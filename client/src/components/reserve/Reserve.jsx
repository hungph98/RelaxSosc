...
const Reserve = ({setOpen, hotelId}) => {
    ...
    const handleSelect = (e) => {
        ...
        setSelectedRooms(checked ? [...selectedRooms, value] : setSelectedRooms.filter((item) => item !== value));
    }
    ...
    return (
        <div className="reserve">
            <div className="reserve-container">
                ...
                {data.map(item =>(
                    <div className="reserve-item" key={item.id}>
                        ...
                        <div className="reverse-select-rooms">
